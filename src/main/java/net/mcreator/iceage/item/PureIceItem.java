...
public class PureIceItem extends IceAgeModElements.ModElement {
	@ObjectHolder("ice_age:pure_ice")
	public static final Item block = null;
	public PureIceItem(IceAgeModElements instance) {
		super(instance, 1);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A Pure Chunk of ice filled with power"));
		}
